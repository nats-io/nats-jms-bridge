...
tasks {
    ...
    dependencies {
        ...
        implementation("io.nats.bridge:nats-jms-bridge:0.24.0-beta21")
        ...
        implementation("io.nats.bridge:nats-jms-bridge-message:0.24.0-beta21")

        implementation("io.nats.bridge:nats-jms-bridge:0.24.0-beta21")

        //implementation("io.nats.bridge:nats-jms-bridge-example-transforms:0.24.0-beta21")
