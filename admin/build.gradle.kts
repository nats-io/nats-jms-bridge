...
val jarVersion = "0.0.0-notforuse-01"
...
//        ))
    ...
    dependencies {
        ...
        implementation("io.nats.bridge:nats-jms-bridge:0.0.0-notforuse-01")
        ...
        implementation("io.nats.bridge:nats-jms-bridge-message:0.0.0-notforuse-01")
