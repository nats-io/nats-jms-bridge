...
val jarVersion = "0.0.0-notforuse-02"
...
//        ))
    ...
    dependencies {
        ...
        implementation("io.nats.bridge:nats-jms-bridge:0.0.0-notforuse-02")
        ...
        implementation("io.nats.bridge:nats-jms-bridge-message:0.0.0-notforuse-02")
