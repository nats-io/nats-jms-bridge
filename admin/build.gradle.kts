...
tasks {
    ...
    dependencies {
        ...
        implementation("io.nats.bridge:nats-jms-bridge:0.20.0-beta16")
        ...
        implementation("io.nats.bridge:nats-jms-bridge-message:0.20.0-beta16")

        implementation("io.nats.bridge:nats-jms-bridge:0.20.0-beta16")

        //implementation("io.nats.bridge:nats-jms-bridge-example-transforms:0.20.0-beta16")
