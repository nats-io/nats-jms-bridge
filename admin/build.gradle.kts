...
tasks {
    ...
    dependencies {
        ...
        implementation("io.nats.bridge:nats-jms-bridge:0.19.1-beta15")
        ...
        implementation("io.nats.bridge:nats-jms-bridge-message:0.19.1-beta15")

        implementation("io.nats.bridge:nats-jms-bridge:0.19.1-beta15")

        //implementation("io.nats.bridge:nats-jms-bridge-example-transforms:0.19.1-beta15")
