...
tasks {
    ...
    dependencies {
        ...
        implementation("io.nats.bridge:nats-jms-bridge:0.21.0-beta18")
        ...
        implementation("io.nats.bridge:nats-jms-bridge-message:0.21.0-beta18")

        implementation("io.nats.bridge:nats-jms-bridge:0.21.0-beta18")

        //implementation("io.nats.bridge:nats-jms-bridge-example-transforms:0.21.0-beta18")
