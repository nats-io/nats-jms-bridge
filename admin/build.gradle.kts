...
tasks {
    ...
    dependencies {
        ...
        implementation("io.nats.bridge:nats-jms-bridge:0.18.0-beta14")
        ...
        implementation("io.nats.bridge:nats-jms-bridge-message:0.18.0-beta14")

        implementation("io.nats.bridge:nats-jms-bridge:0.18.0-beta14")

        //implementation("io.nats.bridge:nats-jms-bridge-example-transforms:0.18.0-beta14")
