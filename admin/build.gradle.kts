...
tasks {
    ...
    dependencies {
        ...
        implementation("io.nats.bridge:nats-jms-bridge:0.17.0-beta12")
        ...
        implementation("io.nats.bridge:nats-jms-bridge-message:0.17.0-beta12")

        implementation("io.nats.bridge:nats-jms-bridge:0.17.0-beta12")

        //implementation("io.nats.bridge:nats-jms-bridge-example-transforms:0.17.0-beta12")
