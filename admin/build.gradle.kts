...
tasks {
    ...
    dependencies {
        ...
        implementation("io.nats.bridge:nats-jms-bridge:0.16.0-beta11")
        ...
        implementation("io.nats.bridge:nats-jms-bridge-message:0.16.0-beta11")

        implementation("io.nats.bridge:nats-jms-bridge:0.16.0-beta11")

        //implementation("io.nats.bridge:nats-jms-bridge-example-transforms:0.16.0-beta11")
