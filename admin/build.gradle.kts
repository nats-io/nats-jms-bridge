...
//        ))
    ...
    dependencies {
        ...
        implementation("io.nats.bridge:nats-jms-bridge:0.27.3-beta24")
        ...
        implementation("io.nats.bridge:nats-jms-bridge-message:0.27.3-beta24")

        implementation("io.nats.bridge:nats-jms-bridge:0.27.3-beta24")

        //implementation("io.nats.bridge:nats-jms-bridge-example-transforms:0.27.3-beta24")
