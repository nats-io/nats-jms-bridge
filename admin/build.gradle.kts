...
tasks {
    ...
    dependencies {
        ...
        implementation("io.nats.bridge:nats-jms-bridge:0.22.0-beta19")
        ...
        implementation("io.nats.bridge:nats-jms-bridge-message:0.22.0-beta19")

        implementation("io.nats.bridge:nats-jms-bridge:0.22.0-beta19")

        //implementation("io.nats.bridge:nats-jms-bridge-example-transforms:0.22.0-beta19")
