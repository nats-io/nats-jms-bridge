...
wget https://github.com/nats-io/nats-jms-mq-bridge/releases/download/0.23.0-beta20-1/nats-bridge-admin-0.23.0-beta20-1.zip
unzip nats-bridge-admin-0.23.0-beta20-1.zip
rm *.zip
```
