...
wget https://github.com/nats-io/nats-jms-mq-bridge/releases/download/0.23.0-beta20/nats-bridge-admin-0.23.0-beta20.zip
unzip nats-bridge-admin-0.23.0-beta20.zip
rm *.zip
```
